...
#ifdef LUAPROC_USE_KTHREADS //NetBSD
#ifdef __unix__
#include <sys/lua.h>
...
#define lpthread_create( thread, attr, routine, arg ) kthread_create( PRI_NONE, KTHREAD_IDLE|KTHREAD_MPSAFE|KTHREAD_TS, NULL, routine, arg, thread, "%s", " " )
